...
const Signup:React.FC<SignupProps> = () => {
    ...
    return <>
        ...
        <form className='space-y-6 px-6 pb-4 ' onSubmit={handleRegister}>
            <h3 className='text-xl font-medium text-white'>Register to ByteBeam</h3>
            <div>
            ...
            <div>
                ...
                <input onChange={handleChange} type="text" name="displayName" id='displayName'  
                className='border-2 outline-none sm:text-sm rounded-lg focus:ring-blue-500 
                focus:border-blue-500
                block w-full p-2.5
                bg-gray-600 border-gray-500 placeholder-gray-400 text-white'
            ...
            <div className='text-sm font-medium text-gray-300 flex'>
